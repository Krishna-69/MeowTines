...
export default function FrontPage() {
    ...
    const sentence = "We have known each other from not sooooo long time but today I have something important to MEOW!!!...\n";
            ...
            <div className="heart opacity-75">
                <div className="text absolute -top-4 z-10 w-72 p-3 h-auto flex flex-col rotate-45 select-none">
                    <p className='w-fit h-fit text-font text-center custom-color-text'>
                        In the midst of life's tumultuous sea and meows!!,
                    </p>
                    <p className='w-fit h-fit text-font text-center custom-color-text'>
                        Amidst mewochaos and meowcertainty,
                    </p>
                    <p className='w-fit h-fit text-font text-center custom-color-text'>
                        I found Meow, my guiding meow light,
                    </p>
                    <p className='w-fit h-fit text-font text-center custom-color-text'>
                        In your meow!, serene and bright.
                    </p>
                </div>
